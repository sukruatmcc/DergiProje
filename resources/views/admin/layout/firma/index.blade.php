                ...
                <div class="row g-0">
                    ...
                    <div class="col">
                        <div class="card-body py-5">
                            ...
                            <p class="card-text">Simple DataTables is a third party plugin that is used to generate the
                                demo table above. For more information about how to use Simple DataTables with your project,
