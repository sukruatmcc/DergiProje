    ...
    <div class="container-xl px-4 mt-n10">
        <div class="card mb-4">
            <div class="row" style="margin-top:7px; margin-left:7px">
                <div class="col-md-4">
                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalCreateDergi"><i
                            class="fa-solid fa-circle-plus"></i>Add Dergi
                    </a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        @foreach ($data as $row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admindergi.show', $row->id) }}"><i class="fa-solid fa-eye"></i></a>
                                </td>
                                </td>
                            </tr>
                        @endforeach
